...
def main():
    ...
    root.title("IP CHECKER by BOB218")  # Set the title of the window
    ...
    title_label1 = ttk.Label(frame, text="In collaboration with ABUSEIPDB", font=("Sylfaen", 14, "italic"))
    title_label1.grid(row=0, column=0, columnspan=3)
    title_label2 = ttk.Label(frame, text="IP CHECKER", font=("Sylfaen", 18, "bold"))
